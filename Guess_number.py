...
def input_validation(value):  # Функция проверки введённого значения на числовое значение
	if value.isdigit() == False:  # Проверка введённого значения на отсутствие символов не являющимися цифрами
...
min_num_0 = input(
	"Введите нижнее значение диапазона внутри которого будет загадываться число:\n")  # Задаём минимальное значение диапазона в котором будет загадываться число
min_num_0 = input_validation(min_num_0)
max_num_0 = input(
	"Введите верхнее значение диапазона внутри которого будет загадываться число:\n")  # Задаём максимальное значение диапазона в котором будет загадываться число
max_num_0 = input_validation(max_num_0)
if max_num_0 <= min_num_0:  # Проверка введённого значения на отсутствие символов не являющимися цифрами
	...
	quit()
max_iteration = input(
	"Введите количество итераций оценки алгоритма угадывания числа:\n")  # Задаётся верхний диапазон цикла по угадыванию числа
max_iteration = input_validation(max_iteration)
if max_iteration == 0:
...
print("Загаданное число в последней итерации:", number, ",было угадано с", count, "попытки")
